...
useEffect(()=>{
  if (dToken) {
    console.log('dashData.latestAppoitnments  :', dashData.latestAppoitnments)
    getDashData()
  }
},[dToken])
...
<div className='m-5'>
  ...
  <div className='flex flex-wrap gap-3'> 
    <div className='flex items-center gap-2 bg-white p-4 min-w-5 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
      ...
      <div>
        <p className='text-xl fron-semibold text-gray-600'>{currency}{dashData.earnings }</p>
  ...
  <div className='bg-white'>
    ...
    <div className='pt-4 border border-t-0'>
       ...
       {
        Array.isArray(dashData.latestAppoitnments) &&
        dashData.latestAppoitnments.map((item,index)=>(
